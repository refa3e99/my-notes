...
# What I've learned
As a programmer, first of all you should understand the purpose of the software you are going to build.
You should know what goals you want to achieve with this software & understand the system you're about to build.
Your code should be simple as possible & not complex.
You should also keep maintaining your code to avoid mistakes in it.
Your code should be clear and understandable by using comments in it; to help other coders to understand it in case you are going to share it.
Develope yourself by practicing, using some technologies is a good idea.
